...
//@Disabled
public class Automatic_Encoder_Op_Mode_Depot extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        //před minerálama
        encoderDrive(TURN_SPEED, ); //90° doleva
        encoderDrive(DRIVE_SPEED,36,36,0);
        //vlevo vedle minerálů
        encoderDrive(TURN_SPEED, ); //135° doprava
        encoderDrive(DRIVE_SPEED, 36,36,0);
        //v team depotu
        encoderDrive(TURN_SPEED); //175° doleva
